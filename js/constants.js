...
export const RIDDLE_DELAY = 15000;
...
const JOKES = [
  ...
  ['', 'WHAT DO BIRDS', "NEED WHEN THEY'RE SICK", 'A TWEET-MENT!', ''],
  ...
  ['', 'WHAT DID THE ICE', 'CREAM SAY TO CAKE?', "YOU'RE SO COOL!", ''],
  ...
  ['', 'WHAT DID ENGLISH', 'SAY TO ALGEBRA?', 'STOP FINDING YOUR X', ''],
  // SILLY/EVERYDAY (55)
  ...
  ['', 'WHY WAS THE', 'CALENDAR SO POPULAR?', 'IT HAD A LOT OF DAYS', ''],
  ...
  ['', 'WHAT DO RAIN', 'CLOUDS WEAR?', 'THUNDERWEAR!', ''],
  ...
  ['', 'WHY DID WOODY', 'GIVE BUZZ A GIFT?', 'TO INFINITY AND BUY!', ''],
  ...
  ['', 'WHAT DO YOU CALL', 'A LAZY NINJA?', 'SLOW-FU!', ''],
